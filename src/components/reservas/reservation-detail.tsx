...
import {
  X, Users, MapPin, Clock, Phone, Mail,
...
import { ReservationQuizAnswers, reservationQuizHasData } from '@/components/reservas/reservation-quiz-answers'
    ...
    <div className="h-full flex flex-col bg-background">
      ...
      <Tabs defaultValue="guest" className="flex-1 flex flex-col min-h-0">
        ...
        <TabsContent value="guest" className="flex-1 overflow-y-auto px-5 py-4 space-y-5">
          ...
          {reservationQuizHasData(reservation) && (
            <ReservationQuizAnswers reservation={reservation} whenEmpty="hide" />
          )}
        </TabsContent>
