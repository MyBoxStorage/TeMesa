...
import { Building2, Users, Calendar, ToggleLeft, ToggleRight, ChevronDown } from 'lucide-react'
...
export default function RestaurantesAdminPage() {
  ...
  const { data: restaurants, isLoading } = api.admin.listRestaurants.useQuery()
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    ...
                    {/* Toggle active */}
                    <button
                      onClick={() => toggleActive.mutate({ restaurantId: r.id, isActive: !r.isActive })}
